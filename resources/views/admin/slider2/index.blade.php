...
@section('title', 'Slider 2 Listesi')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Slider 2 Listesi</h3></div>
              <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Slider 2 Listesi</h5>
                            ...
                            <tbody class="connectedSortable">
                                @foreach($sliders as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.slider2.edit', $item->slider_id) }}" class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Düzenle
                                            </a>
                                            <form action="{{ route('admin.slider2.destroy', $item->slider_id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
