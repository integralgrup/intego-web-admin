...
@section('title', 'Slider 2 Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Slider 2 Güncelleme</h3></div>
              <div class="col-sm-6">
        ...
        <div class="app-content">
                ...
                <div class="card">
                    ...
                    ?>
                    <div class="card-body">
                        <form action="{{ route('admin.slider2.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" style="display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description_{{ $language->lang_code }}" class="form-control" id="description_{{ $language->lang_code }}" required>{{ $description[$language->lang_code] ?? '' }}</textarea></textarea>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.slider2.index') }}" class="btn btn-secondary">Geri Dön</a>
                            </div>
                        </form>
                    </div>
                </div>
