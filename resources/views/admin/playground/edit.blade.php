...
@section('title', 'Oyun Alanı Güncelleme')
...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Oyun Alanı Güncelleme</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Anasayfa</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Oyun Alanı Yönetimi</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                ...
                <div class="card">
                    ...
                    <?php 
                        foreach($playgrounds as $playground){
                            $playground_id[$playground->lang] = $playground->playground_id;
                            $seo_url[$playground->lang] = $playground->seo_url;
                            $title[$playground->lang] = $playground->title;
                            $image[$playground->lang] = $playground->image;
                            $alt[$playground->lang] = $playground->alt;
                            $seo_title[$playground->lang] = $playground->seo_title;
                            $seo_description[$playground->lang] = $playground->seo_description;
                            $seo_keywords[$playground->lang] = $playground->seo_keywords;
                            $sort[$playground->lang] = $playground->sort;
                        }
                    ?>
                    <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="tab-{{ $language->id }}" role="tabpanel" aria-labelledby="tab-{{ $language->id }}-tab">
                                    <div class="card-body" >
                                        ...
                                        <input type="hidden" name="playground_id" value="{{ $playground_id[$language->lang_code] }}">
                                        <div class="grids-3">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @if($image[$language->lang_code])
                                                    <img src="{{ $language->domain .'/'.  getFolder(['uploads_folder','playground_images_folder'], $language->lang_code) . '/' . $image[$language->lang_code] }}" alt="{{ $alt[$language->lang_code] }}" style="width: 200px; height: auto; margin-top: 10px;">
