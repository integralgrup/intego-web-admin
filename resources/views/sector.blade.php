...
@section('content')
    ...
    <div class="image-video relative pointer-events-none w-full h-full overflow-hidden">
        <?php if ($imageOrVideo == "image") { ?>
            <img src="<?= $breadcrumbImage ?>" alt="<?= $sector->bg_alt ?>" width="1785" height="400" class="w-full h-full object-cover">
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-2/5 md:w-full md:!pr-0">
                        <div class="image-wrapper reveal w-full h-[650px] md:h-[580px] sm:h-[320px] relative">
                            <img src="<?= env('HTTP_DOMAIN').'/'.getFolder(['uploads_folder','sector_images_folder'], app()->getLocale()).'/'. $sector->image ?>" alt="Sektör Detay" width="1045" height="539" class="w-full h-full object-cover relative z-2">
        ...
        <section class="gallery mb-[170px] xl:mb-[120px] lg:mb-[90px] md:mb-[60px] overflow-hidden">
            <div class="container max-w-[1650px]">
                <h3 class="reveal text-[46px] xl:text-[32px] lg:text-[24px] leading-[60px] xl:leading-[50px] lg:leading-[40px] md:leading-[36px] tracking-[-0.46px] font-light text-secondary-main mb-[60px] xs:mb-[30px] text-center">
                    Intego Playground <br> <span class="font-bold">Galeri Medyası</span>
                </h3>
                ...
                <div class="flex flex-wrap items-center">
                    <div class="w-3/5 md:w-full pr-[77px] md:mt-[15px] md:p-0 md:order-2">
                        <div class="image-wrapper reveal w-full sm:h-auto relative flex flex-col sm:flex-col-reverse" id="brand-logo-image-area">
                            <img src="{{ asset( getFolder(['uploads_folder', 'brand_images_folder'], $brands[0]->lang) . '/' . $brands[0]->image ) }}" alt="Markamız" width="814" height="696" class=" w-full h-[700px] md:h-[580px] sm:h-[320px] object-cover relative z-2 transition-all duration-450 [&.changed]:opacity-0 [&.changed]:translate-y-[5px]" id="brand-image">
